  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Cartoonized',
          style: GoogleFonts.kalam(textStyle: Theme.of(context).textTheme.titleMedium),
        ),
      ),
      body: Column(
          ...
          child: Row(
            children: [
              IconButton(
                ...
                icon: Icon(Icons.share, color: shareFile.value == '' ? Colors.grey : Theme.of(context).iconTheme.color),
              ),
              IconButton(
                onPressed: saveImage,
